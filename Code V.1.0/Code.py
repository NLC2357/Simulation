...
if __name__ == "__main__":
 ...
 ### ====================== PLOTS ======================
    ...
    Display(T, 'Temperature')
    Display(Y_CH4, 'CH4 Concentration')
    Display(Y_O2, 'O2 Concentration')
    Display(Y_N2, 'N2 Concentration')
    Display(Y_H2O, 'H2O Concentration')
    Display(Y_CO2, 'CO2 Concentration')
